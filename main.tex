...
\begin{figure}
\noindent
\includegraphics[width=\textwidth]{figures/1-flowchart2}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/2-map_ba_panels}
...
\hline
\end{tabular}
\caption{Balancing authorities used in the high renewable scenario in this study, this study with sited wind and solar capacity in gigawatts. *Western Area Power Administration}
\label{tab:bas}
\end{table}
...
\begin{figure}
\noindent
\includegraphics[width=\textwidth]{figures/3-severity_future_nz_ws_droughts}
...
\begin{figure}
\noindent
\includegraphics[width=\textwidth]{figures/4-severity_diff_hist_future_nz_ws_droughts}
...
\begin{figure}
\noindent
\includegraphics[width=\textwidth]{figures/5-duration_future_nz_ws_droughts}
...
\includegraphics[width=\linewidth]{figures/6-spatial_connectivity_seasonal_nz_ws_droughts}
\end{adjustwidth}
...
\begin{figure}
\noindent
\includegraphics[width=\textwidth]{figures/7-connected_event_diff_nz_ws_droughts}
...
\begin{figure}
    ...
    \caption{Difference in average annual normalized energy drought severity between the future and historical periods for the business-as-usual scenario, which involves a high renewable scenario by 2050. Severity has been normalized per BA to allow the data to be compared across BAs.}
...
\begin{figure}
    ...
    \caption{Energy drought duration for the business-as-usual scenario, which involves a high renewable grid by 2050. Note that the figure does show boxplots, but in most BAs the distribution of drought duration is heavily skewed such that most boxes are collapsed on at the lowest value.}
